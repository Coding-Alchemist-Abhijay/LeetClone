...
import CreatePlaylistModal from "@/components/ui/create-playlist";
import AddToPlaylistModal from "@/components/ui/add-to-playlist";
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        toast.error(result.errors || "Failed to delete problem");
      }
    } catch (error) {
